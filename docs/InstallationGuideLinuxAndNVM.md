...
![Successful NVM installation output in your terminal](img/terminal-nvm.png)
...
You have NVM installed, but you still need to install Node.js. You will need to have the latest LTS version of Node installed as of February 2021 (14.x).
