...
First, go to the [Node.js download page](https://nodejs.org/en/) and download the _LTS version_ (version 14.x as of February 2021) and reinstall Node.js.
...
You need to [create a Github account](https://github.com/join) if you do not have one.

### Node.js and NPM Packages

Node.js is a JavaScript runtime engine. Basically, it allows you to run JavaScript programs outside of the browser.

You will need to have the latest _LTS_ version of Node installed as of February 2021 (14.x). If you already have Node.js installed, type `node -v` in Git Bash. If you do not have the latest version, you will need to remove Node.js and reinstall it again.
...
To install Node.js, go to https://nodejs.org/en/ and click on the _14.15.X LTS_ version.
