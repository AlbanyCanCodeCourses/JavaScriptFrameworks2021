  ...
  return (
    <form method = "POST" className="container mt-4" onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        ...
        <input id="city" name="city" type="text" className="form-control" value={props.formValues.city}
          onChange={handleChange}/>
      </div>
      <div className="mb-3">
        ...
        <select id="state" name="state" className="form-control" value={props.formValues.state}
          onChange={handleChange}>
          <option></option>
      ...
      <div className="mb-3">
        ...
        <select id="country" name="country" className="form-control" value={props.formValues.country}
          onChange={handleChange}>
          <option></option>
